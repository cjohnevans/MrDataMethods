% this only works with samples.txt files from Caruyer website, not 
% on direction files generated by caruyer multishell scrips in qspace
% github repo.

in_file  = '/home/sapje1/notebooks/2024/dat/samples.txt';
out_file = '/home/sapje1/notebooks/2024/dat/samples_out.txt';

in_file = '/home/sapje1/Downloads/samples.txt'
out_file = '/home/sapje1/Downloads/samples_out.txt'

%in_file = '/home/sapje1/Downloads/01-shells-12.txt'
%out_file = '/home/sapje1/Downloads/01-shells-12_out.txt'


delimiter = '\t';
% web site starts here
startRow = 23;
% multishell script from github starts here
%startRow = 2
formatSpec = '%f%f%f%f%[^\n\r]';
...
necessary_bvals = [1000];
scanner_bval = max(necessary_bvals); %3000;%s/mm2 as set on the scanner

if length(unique(shells)) ~= length(necessary_bvals)
